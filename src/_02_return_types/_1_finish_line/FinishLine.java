...
public class FinishLine {
	...
	public static void main(String[] args) {
		...
		int bob = getTotalDistance();
		//4. Call the hasCrossedFinishLine() method and save what is returned into a variable
		boolean bobb = hasCrossedFinishLine();
		//5. If the robot has crossed the finish line... 
			if(bobb==true) {
				JOptionPane.showMessageDialog(null, "The robot finished and it went "+bob+" units");
			}else {
				JOptionPane.showMessageDialog(null, "The robot  did not finish and it went "+bob+" units");
			}
